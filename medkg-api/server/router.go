...
func InitRouter(r *gin.Engine) {
	...
	r.StaticFile("/viz", "./static/viz.html")
	r.StaticFile("/docs", "./static/docs.html")
	...
	// r.StaticFile("/contact", "./static/contact.html")
	// r.StaticFile("/about-us", "./static/about-us.html")
	r.StaticFile("/documentation", "./static/docs.html")
...
func InitDataEndpoint(r *gin.Engine) {
	...
	r.POST("/nodes/graph", controllers.GetNetworkGraphForIdHandler(client))
	...
	r.GET("/api/node-details", controllers.NodeDetailsForElementIdHandler(client))
	r.POST("/api/node-relations", controllers.GetNodeRelationsHandler(client))
